...
const Login: React.FC = () => {
  ...
  return (
    <React.Fragment>
      ...
      <>
        <h1 className=" uppercase text-4xl font-semibold text-center border-b border-b-1 border-cyan-500 text-cyan-500 p-2 ">Login</h1>
        <form
        ...
        >
          ...
          <ErrorMessage
            ...
            errors={errors}
            render={({ message }) => (
              <p className={`text-red-500 p-1 text-xs ${message ? 'visible' : 'invisible'}`}>
                {message}
              </p>
            )}
          />
          ...
          { err && <p className={`text-red-500 p-1 text-xs `}>
                {errorText}
              </p>}
        </form>
      </>
